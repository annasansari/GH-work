...
var make_error = [12, 334, 45, 56, 43, 2];
...
var check2 = 'Ansari';
var check3 = 18;
var check4 = ['Honda', 23, true, undefined, "Civic"];
...
*/
var username = ['Anas', 'Munneb', 'Faizan', 'Admin', 'Hasnain'];
/*31:
...
*/
var current_users = ['anas', 'talha', 'muneeb', 'faizan', 'Hasnain'];
var new_users = ['ajaz', 'ali', 'ubaid', 'asim', 'muneeb'];
for (var i = 0; i < new_users.length; i++) {
    ...
    if (!isAvailable) {
        console.log("username '".concat(newUser, "' is not available"));
    }
    else {
...
*/
var pizzas = ['chees', 'pepperoni', 'chicken'];
...
*/
var make_shirt = function (shirt_size) {
    console.log("The size of shirt is ".concat(shirt_size));
};
...
*/
var describe_city = function (arg1, arg2) {
    console.log("".concat(arg1, " is in ").concat(arg2, "."));
};
...
var album1 = make_album('Atif Aslam', 'Tere Bin', 3);
var album2 = make_album('Arjit', 'Tere Hawale', 0);
var album3 = make_album('Asim Azhar', 'Hello world', 1);
console.log(album1);
console.log(album2);
console.log(album3);
/*40:
...
var magician_names = ['Anas', 'Ayaz', 'Ajaz', 'Muneeb', 'Faizan'];
// show_magicians(magician_names)
var make_great = function (magician) {
    ...
    for (var i = 0; i < magician.length; i++) {
        new_magician_names.push(magician_names[i]);
        if (magician[i] === 'Anas') {
            console.log("".concat(magician[i], " is great Magician"));
        }
        if (magician[i] === 'Ayaz') {
            console.log("".concat(magician[i], " is great Magician"));
        }
...
var magician = ['Anas', 'Ayaz', 'Ajaz', 'Muneeb', 'Faizan'];
var greatMagicianNames = make_great(magician.slice());
...
var sandwich = function () {
    ...
    for (var i = 0; i < items.length; i++) {
        console.log("ther person ordered ".concat(items[i][0], " sandwich with ").concat(items[i][1], " and ").concat(items[i][2]));
    }
};
var items = ['Butter', 'Bread', 'Slice'];
var items1 = ['Cheesy', 'Mayonees', 'Ketchup'];
var items2 = ['Chiken', 'Onion', 'Potato'];
sandwich(items, items1, items2);
/*44
Cars: Write a function that stores information about a car in a Object. The function should always receive a manufacturer and a model name. It should then accept an arbitrary number of keyword arguments. Call the function with the required information and two other name-value pairs, such as a color or an optional feature. Print the Object that’s returned to make sure all the information was stored correctly.
 */
var car_info = function (name, manufacturer) {
    var option = [];
...
var car = car_info('Mira', 'Toyota', ['color', 'grey'], ['Year', 2017]);
console.log(car);
